    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden font-sans dir-rtl" dir="rtl">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs mb-4">
            <Zap className="w-3.5 h-3.5" /> تشكيلة النخبة لعام 2026
          </span>
          <h2 className="text-4xl md:text-6xl font-black tracking-tight mb-6">
            الفخامة تلتقي بـ <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">الدقة المتناهية</span>
          </h2>
          <p className="text-slate-400 text-base md:text-lg max-w-2xl mx-auto">
            اختار ساعتك القادمة المصممة بأعلى معايير الدقة والجمال، استمتع بتجربة تسوق سريعة ومميزة.
          </p>
        </motion.div>
      </section>
